...
//                CentralControl.getCurrentPlayer().setLocation(11);
//            }
//        }
        CentralControl.getCurrentPlayer().rollDices();
        //Using roll dice method in player class
    ...
    public static void Start() {
        ...
        try {
            for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
                if (System.getProperty("os.name").equals(info.getName())) {
